      ...
      <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/60 to-transparent">
        <div className="absolute bottom-0 p-4 sm:p-6 md:p-8 text-white">
          ...
          <button
            ...
            className="bg-gradient-to-r from-blue-600 to-blue-400 px-6 py-2 sm:px-8 sm:py-3 rounded-full
              text-sm sm:text-base md:text-lg font-semibold shadow-lg hover:shadow-xl transform hover:-translate-y-1
